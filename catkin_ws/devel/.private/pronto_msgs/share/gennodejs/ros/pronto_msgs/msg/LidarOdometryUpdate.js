...
class LidarOdometryUpdate {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LidarOdometryUpdate(null);
  ...
  static datatype() {
    ...
    return 'pronto_msgs/LidarOdometryUpdate';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f571239a848b48578d24ae00902925c8';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LidarOdometryUpdate(null);
...
module.exports = LidarOdometryUpdate;
