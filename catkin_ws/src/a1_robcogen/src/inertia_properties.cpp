...
pronto::a1::dyn::InertiaProperties::InertiaProperties()
{
    ...
    tensor_FR_hip.fill(
        m_FR_hip,
        com_FR_hip,
        Utils::buildInertiaTensor<Scalar>(ix_FR_hip,iy_FR_hip,iz_FR_hip,0.0,ixz_FR_hip,iyz_FR_hip) );
    ...
    tensor_FR_calf.fill(
        m_FR_calf,
        com_FR_calf,
        Utils::buildInertiaTensor<Scalar>(ix_FR_calf,iy_FR_calf,iz_FR_calf,ixy_FR_calf,0.0,0.0) );

    com_FL_hip = Vector3(comx_FL_hip,comy_FL_hip,comz_FL_hip);
    tensor_FL_hip.fill(
        m_FL_hip,
        com_FL_hip,
        Utils::buildInertiaTensor<Scalar>(ix_FL_hip,iy_FL_hip,iz_FL_hip,0.0,ixz_FL_hip,iyz_FL_hip) );
    ...
    tensor_FL_calf.fill(
        m_FL_calf,
        com_FL_calf,
        Utils::buildInertiaTensor<Scalar>(ix_FL_calf,iy_FL_calf,iz_FL_calf,ixy_FL_calf,0.0,0.0) );

    com_RR_hip = Vector3(comx_RR_hip,comy_RR_hip,comz_RR_hip);
    tensor_RR_hip.fill(
        m_RR_hip,
        com_RR_hip,
        Utils::buildInertiaTensor<Scalar>(ix_RR_hip,iy_RR_hip,iz_RR_hip,0.0,ixz_RR_hip,iyz_RR_hip) );
    ...
    tensor_RR_calf.fill(
        m_RR_calf,
        com_RR_calf,
        Utils::buildInertiaTensor<Scalar>(ix_RR_calf,iy_RR_calf,iz_RR_calf,ixy_RR_calf,0.0,0.0) );

    com_RL_hip = Vector3(comx_RL_hip,comy_RL_hip,comz_RL_hip);
    tensor_RL_hip.fill(
        m_RL_hip,
        com_RL_hip,
        Utils::buildInertiaTensor<Scalar>(ix_RL_hip,iy_RL_hip,iz_RL_hip,0.0,ixz_RL_hip,iyz_RL_hip) );
    ...
    tensor_RL_calf.fill(
        m_RL_calf,
        com_RL_calf,
        Utils::buildInertiaTensor<Scalar>(ix_RL_calf,iy_RL_calf,iz_RL_calf,ixy_RL_calf,0.0,0.0) );

}


void pronto::a1::dyn::InertiaProperties::updateParameters(const RuntimeInertiaParams& fresh)
{
    this-> params = fresh;
}
