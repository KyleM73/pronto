...
const pronto::a1::dyn::ForwardDynamics::ExtForces
    pronto::a1::dyn::ForwardDynamics::zeroExtForces(Force::Zero());

pronto::a1::dyn::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void pronto::a1::dyn::ForwardDynamics::fd(
    JointState& qdd,
    Acceleration& base_a,
