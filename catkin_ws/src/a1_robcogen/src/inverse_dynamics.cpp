...
using namespace pronto::a1::dyn;

// Initialization of static-const data
const pronto::a1::dyn::InverseDynamics::ExtForces
pronto::a1::dyn::InverseDynamics::zeroExtForces(Force::Zero());

pronto::a1::dyn::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
{
#ifndef EIGEN_NO_DEBUG
    std::cout << "Robot a1, InverseDynamics::InverseDynamics()" << std::endl;
...
void pronto::a1::dyn::InverseDynamics::id(
...
void pronto::a1::dyn::InverseDynamics::G_terms_fully_actuated(
...
void pronto::a1::dyn::InverseDynamics::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
void pronto::a1::dyn::InverseDynamics::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
...
void pronto::a1::dyn::InverseDynamics::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'RL_calf'
