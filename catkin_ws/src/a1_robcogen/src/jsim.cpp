...
pronto::a1::dyn::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const pronto::a1::dyn::JSIM& pronto::a1::dyn::JSIM::update(const JointState& state) {
...
void pronto::a1::dyn::JSIM::computeL() {
...
void pronto::a1::dyn::JSIM::computeInverse() {
    computeLInverse();
...
void pronto::a1::dyn::JSIM::computeLInverse() {
