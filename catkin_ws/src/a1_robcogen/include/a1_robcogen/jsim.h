#ifndef RCG_A1_JSIM_H_
#define RCG_A1_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot a1.
 */
class JSIM : public iit::rbd::StateDependentMatrix<pronto::a1::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<pronto::a1::JointState, 18, 18, JSIM> Base;
    public:
